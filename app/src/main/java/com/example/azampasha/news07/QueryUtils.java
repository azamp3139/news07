...
public final class QueryUtils {
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> myNews = extractFeatureFromJson(jsonResponse);
    ...
    private static List<News> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i <newsArray.length(); i++) {
                ...
                String mtime = currentNews.getString("publishedAt");
                String murl = currentNews.getString("url");
                String mimg=currentNews.getString("urlToImage");
                ...
                News newNews = new News(mtitle, mauthor, mtime, murl,mimg);
